...
interest_rate = input("What is the interest rate (in percentage points): ")
...
def main():
    ...
    choice = input("Enter 1 to calculate your final amount \nEnter 2 for to calculate the interest rate needed \nEnter 3 to calculate the investment period needed \nEnter 4 to calculate the initial investment needed \nEnter number here: ")
    print(choice)
main()
